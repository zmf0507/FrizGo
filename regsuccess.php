...
<body>
  ...
  <br>
  <?php
$q = $conn->prepare("SELECT * FROM payment where cid = ? order by payid DESC");
...
$rows = $q->fetch();
  ...
  <div class="container">
    <br><br><br><br>
    <br><br><br><br>
    <h1 align='center'>Congratualtions <?php echo $_SESSION['name']; ?>..You have successfully registered with FrizGo</h1><br><br>
    <a href="account.html">
      <button style="display: block; margin: 0 auto;" type="button" class="btn btn-success">Click here to login and start shopping</button>
    </a>
    <br><br><br><br>
    <br><br><br><br>
    <br><br><br><br>
